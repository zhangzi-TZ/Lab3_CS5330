...
def get_data_loaders(batch_size_train=2, batch_size_val=4, num_workers=4):
    """Create and return DataLoaders for training and validation sets"""
    train_dataset = LegoDataset("./selected_600/train", transform=transform)
    val_dataset = LegoDataset("./selected_600/val", transform=transform)
...
def get_test_loader(batch_size_test=4, num_workers=4):
    """Create and return DataLoader for the test set"""
    test_dataset = LegoDataset("./selected_600/test", transform=transform)
